  ...
  return (
    <div className="grid justify-items-center gap-8 pb-28 relative">
      <p className=" text-4xl md:text-6xl font-black text-center leading-normal md:leading-normal">
        打造一个完美的、现象级的、充满活力的网站
      </p>
      <p className="text-xl text-gray-700 md:w-1/2 text-center">
        在这里，你可以放心地把你的网站建设成为一个现象级的网站。
      </p>
      <div>
        <button className="rounded hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-300 bg-blue-500 text-base text-white py-3 px-8">
          立即试用
        </button>
        <button className="rounded hover:bg-gray-600 hover:shadow-lg hover:shadow-gray-300 bg-gray-500 text-base text-white py-3 px-8 ml-8">
          了解更多
        </button>
      </div>
