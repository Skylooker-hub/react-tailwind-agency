...
function HowitWorks() {
  return (
    <div>
      <SectionHeading
        title="工作流程"
        subtitle="如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作"
      />
        ...
        {[1, 2, 3, 4, 5, 6].map(v => (
          <div key={v} className="grid justify-items-center gap-y-2">
            ...
            >
              ...
              />
              <path d="M36 26L39 23L36 20" stroke="white" strokeWidth="2" strokeLinecap="square" />
            </svg>
