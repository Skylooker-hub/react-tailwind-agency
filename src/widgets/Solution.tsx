...
function Solution() {
  return (
    <div>
      <SectionHeading
        title="解决方案"
        subtitle="解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案"
      ></SectionHeading>
      <div className="grid lg:grid-cols-2 mt-20 gap-20">
        <div>
          ...
          <p className="mt-4 mb-8 text-gray-500">
            强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具
          </p>
              ...
              >
                ...
                <div className="flex justify-between relative">
                  <p className="text-lg leading-7 mt-1">
                    构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统
                  </p>
                  <svg
                    width="38"
                    height="38"
